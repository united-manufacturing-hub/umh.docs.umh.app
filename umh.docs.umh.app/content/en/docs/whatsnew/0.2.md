...
- Monitor uptime (Device, UMH, Companion).
- Fixed companion not sending all datapoints, when rate was greater 1Hz.
- Increased stability of the companion.
- Improved handling on connection loss while downloading dependencies.
- Improved handling when having many instances.
- TODO: Add frontend changes here.
