...
## How can I use it?
  ...
  You need a running instance of the United Manufacturing Hub Stack with data
  (like in the linked tutorial) to create an alert.
        ...
        - Subsection **A** is, by default the selection of your values: You can 
          ...
          - First, you must select the value you want to create an alert for. In 
            ...
            **[processvaluetable](https://umh.docs.umh.app/docs/architecture/datamodel/database/processvaluetable/)**
            ...
            differentiate between different values of the same sensor; if you 
            select the **ConcentrationNH3** value from the example and more than
            one of the selected values violates your rule in the selected time
